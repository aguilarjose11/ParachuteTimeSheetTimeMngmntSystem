...
personalData: [lname: string/null, fname: string/null, dep: string/null]
    - Information of the new user to be made.
    - _If this list is populated with exactly three strings, the constructor_
      _will create a new user_

#### Description:
Based on wether the personalData list is empty or not, the constructor creates a
new user or not.
